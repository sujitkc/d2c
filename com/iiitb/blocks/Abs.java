...
public class Abs extends Block {
	...
	public void setBlockNode(ICFG mergedCFG,ArrayList<Variable> vars) throws Exception {
		lhs = vars.get(0);
		rhs = new Variable("| " + vars.get(0).getName() + " |",mergedCFG);
	...
	public Abs(String input1,String name) throws Exception {
	...
	public Abs(String blockName) throws Exception {
